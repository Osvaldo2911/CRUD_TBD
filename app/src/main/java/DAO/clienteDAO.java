...
public interface clienteDAO {
    ...
    public ClienteT buscarUsuario(String clientNo);
    ...
    public ClienteT eliminarUsuario(String clientNo);

    @Query("update ClienteT set fName=:fName,lName=:lName,telNo=:telNo,prefType=:prefType,maxRent=:maxRent where clientNo=:clientNo")
    public ClienteT modificarUsuario(String clientNo, String fName, String lName, String telNo, String prefType, String maxRent);
